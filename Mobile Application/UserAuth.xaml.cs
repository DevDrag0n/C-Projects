...
namespace Module2
{
    ...
    public sealed partial class UserAuth : Page
    {
        ...
        public static MobileServiceClient MobileService = new MobileServiceClient("your-service.azurewebsites.fail");
        ...
        private async Task btnSubmit_ClickAsync(object sender, RoutedEventArgs e)
        {
